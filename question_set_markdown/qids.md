...
- questionnaire: CESPHN_depressed mood

1. **Question**: Please select the response to each item that best describes you for the **past seven (7) days**. Falling asleep:
   - code: QIDS_1
   - options:
...
2. **Question**: Sleep during the night:
   - code: QIDS_2
   - options:
...
3. **Question**: Waking up too early:
   - code: QIDS_3
   - options:
...
9. **Question**: Has your weight: (for this question only, please think about the last two weeks)
   - code: QIDS_WEIGHT
   - options:
     - My weight has not changed
     - My weight has decreased
     - My weight has increased
10. **Question**: Decreased weight:
   - code: QIDS_8
   - options:
     - I feel as if I have had a slight weight loss
     - I have lost 1kg or more
     - I have lost 2.5kg or more
11. **Question**: Increased weight:
   - code: QIDS_9
   - options:
     - I feel as if I have had a slight weight gain
     - I have gained 1kg or more
     - I have gained 2kg or more
12. **Question**: Concentration/decision making:
   - code: QIDS_10
   - options:
...
14. **Question**: Thoughts of death or suicide:
   - code: QIDS_12
   - options:
...
17. **Question**: Feeling slowed down:
   - code: QIDS_15
   - options:
     - I think, speak, and move at my usual rate of speed
     - I find that my thinking is slowed down or my voice sounds flat or dull
