...
- questionnaire: Main_Butterfly questionnaire
...
2. **Question**: Please specify major medical problem(s):
   ...
   - options:
     ...
     - Electrolyte imbalance (e.g. severe dehydration, fluid loss, undernourishment)
     - HIV or AIDS
     - Hospitalisation due to eating disorder
